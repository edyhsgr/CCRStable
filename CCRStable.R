...
numericInput("NetMigrationAdjustLevel","Net migration adjustment (annual, percent of population)",0,-25,25,step=.25),
...
#ALSO NEED TO LOOK AT MORTALITY ADJUSTMENT FOR AGES 0to4 AND HOW TO INCLUDE IT GIVEN iTFR 
