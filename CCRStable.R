...
#NEED TO LOOK AT THIS NEXT (MORT-ADJUSTMENT) PORTION MORE, MIGHT BE TOO-SHORTCUT ARITHMETIC FOR SURE
#MAY NEED TO LAYER MORTALITY FOR THE BASE AND ADD THE ADJUSTMENT TO JUST THAT
#OR MAYBE I HAVE IT RIGHT - I'M NOT SURE YET
#		
#ALSO NEED TO LOOK AT MORTALITY ADJUSTMENT FOR AGES 0to4 AND WHETHER AND HOW TO INCLUDE IT GIVEN iTFR 
#(GETS INTO ~DEFINITIONS AND INTERPRETATIONS AND WANTS/NEEDS, BUT THINKING COULD BE HELPFUL TO INCLUDE IT)
